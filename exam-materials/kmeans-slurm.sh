...
# enable email notification of job completion (optional)
...
# Full performance benchmark of all combinations of data files and processor counts
...
# Iterate over all processor/data file combinations
for NP in $ALLNP; do
